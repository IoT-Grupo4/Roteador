...
class OSPFController(object):
    ...
    def __init__(self):
        ...
        self.raise_count = 0
        self.ifaces = self.__discover_interfaces()
        super(OSPFController, self).__init__()

    def __discover_interfaces(self):
        # Descobre as interfaces do roteador e retorna uma lista com os nomes

        if_prefix = ConfigHandler.config["if_prefix"]

        # utilizamos a descoberta de vizinhos para identificar as interfaces participantes
    ...
    def __set_priority(self, if_name, cost):
    ...
    def raise_priority(self):
        ...
        if self.raise_count >= delay_increment:
            ...
            for iface in self.ifaces:
                ...
                self.__set_priority(iface, new_cost)
